      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        <div className="p-4 bg-green-50 border border-green-200 rounded-lg text-center transition-all hover:shadow-lg">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <Title level={5} className="!m-0 text-green-700">
              Cash Payment
            </Title>
          </div>
          <Text strong className="text-3xl text-green-600 block">
            {formatCurrency(cashPrice)}
          </Text>
          <Text type="secondary" className="text-xs mt-1 block">
            Includes 5% upfront payment discount
          </Text>
        </div>
        ...
        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg text-center transition-all hover:shadow-lg">
          ...
          <Text strong className="text-3xl text-blue-600 block">
            {formatCurrency(installmentPrice)}
          </Text>
          <Text type="secondary" className="text-xs mt-1 block">
            per month, over 24 months (0% interest)
          </Text>
        </div>
      </div>
